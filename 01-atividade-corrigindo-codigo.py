...
for i in range(5):
    ...
    media_pares = soma_pares / quantidade_pares / media_impares = soma_impares / quantidade_impares if quantidade_impares > 0 else 0
    ...
    print(f"Média dos números impares: {media_impares:.2f}")
    print(f"Média de todos os números: {media_geral:.2f}")
    print(f"Ordem invertida dos números: ")
